...
![DeepVue Pre-Market screener, final filter configuration, 3 results](Images/Day11-screener-filters.png)
...
![NOW Trade — VWAP rejection short, decline well past target](Images/NOW-Trade-Day11.png)
...
![DOW Trade — rejection of the gap-up open, steady decline to target](Images/DOW-Trade-Day11.png)
...
![DGX Trade — breakdown from the chop, target reached, then a full reversal afterward](Images/DGX-Trade-Day11.png)
